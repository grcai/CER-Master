...
if __name__ == "__main__":
	...
	buffer1 = utils.ReplayBuffer1(state_dim, action_dim)
	buffer2 = utils.ReplayBuffer2(state_dim, action_dim)
	buffer3 = utils.ReplayBuffer3(state_dim, action_dim)
	buffer4 = utils.ReplayBuffer4(state_dim, action_dim)
	buffer5 = utils.ReplayBuffer5(state_dim, action_dim)
	buffer6 = utils.ReplayBuffer6(state_dim, action_dim)
	buffer7 = utils.ReplayBuffer7(state_dim, action_dim)
	buffer8 = utils.ReplayBuffer8(state_dim, action_dim)
	buffer9 = utils.ReplayBuffer9(state_dim, action_dim)
	buffer10 = utils.ReplayBuffer10(state_dim, action_dim)
	...
	for t in range(int(args.max_timesteps)):
		...
		if t > 0 and (t+1) % args.cluster_num == 0:
			...
			index = BufferList[k].Choose_sample(labels,args.km_num)
			kinds_i = [0]
